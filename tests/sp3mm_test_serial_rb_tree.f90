program sp3mm_serial_rb_tree
    ...
    if (info /= 0) then
        ...
        call spmm_serial_rb_tree(r, ac, rac, info)
        spmm1_time = omp_get_wtime() - spmm1_time
        if (info /= 0) error stop
        spmm2_time = omp_get_wtime()
        call spmm_serial_rb_tree(rac, p, out_to_check,info)
        ...
        if (command_argument_count() >= 5) then
            ...
            write (*, '(A,",",A,",",A,",",A,",",A,",",ES12.6,",",I0,",",I0,",", &
                        I0,",",I0,",",ES12.6,",",I0,",",I0,",",I0,",",ES12.6)') &
                                        "serial_rb_tree", trim(collection), &
...
end program sp3mm_serial_rb_tree