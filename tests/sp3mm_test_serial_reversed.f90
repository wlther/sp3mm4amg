program sp3mm_test_serial_reversed
    use omp_lib
    use psb_base_mod
    use sp3mm_test_mod
    implicit none
        ...
        if (command_argument_count() >= 5) then
            ...
            write (*, '(A,",",A,",",A,",",A,",",A,",",ES12.6,",",I0,",",I0,",", &
                        I0,",",I0,",",ES12.6,",",I0,",",I0,",",I0,",",ES12.6)') &
                                        "serial_reversed", trim(collection), &
...
end program sp3mm_test_serial_reversed